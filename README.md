...
We provide the code for the experiments of the NeRF-N3F setting. **NOTE:** The repository contains currently the settings for the flower dataset (see flower video above). We will add the rendering settings for the other scenes in the next days.
